              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left">
                ...
                <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 bg-gradient-to-br from-indigo-primary/20 to-purple-accent/20 rounded-lg flex items-center justify-center border border-white/5">
                      <ShieldCheck className="w-3.5 h-3.5 text-indigo-primary" />
                    </div>
