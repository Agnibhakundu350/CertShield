    ...
    <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
      ...
      >
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 bg-gradient-to-br from-indigo-primary/20 to-purple-accent/20 rounded-2xl flex items-center justify-center shadow-2xl border border-white/10 relative group overflow-hidden">
            <div className="absolute inset-0 bg-indigo-primary/10 opacity-0 group-hover:opacity-100 transition-opacity" />
            <ShieldCheck className="w-8 h-8 text-indigo-primary relative z-10" />
          </div>
          <div>
            <h1 className="text-3xl font-poppins font-bold bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">CertShield Authority</h1>
